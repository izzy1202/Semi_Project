...
public class Member {
	...
	public Member(int userNo, String userId, String userPwd, String userName, String phone, String email,
			String address, Date joinDate, Date modifyDate, String status, int userRole) {
		super();
		this.userNo = userNo;
		this.userId = userId;
	...
	public Member(int userNo, String userId, String userName, String phone, String address) {
		super();
		this.userNo = userNo;
		this.userId = userId;
		this.userName = userName;
	...
	public String toString() {
		return "Member [userNo=" + userNo + ", userId=" + userId + ", userPwd=" + userPwd + ", userName=" + userName
				...
				+ ", modifyDate=" + modifyDate + ", status=" + status + ", userRole=" + userRole + "]";
	}
